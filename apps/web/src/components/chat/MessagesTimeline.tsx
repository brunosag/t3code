...
function TimelineLoadEarlierHeader({
  ...
  return (
    <div className={fade ? "pt-[var(--workspace-titlebar-scroll-fade-height)]" : "pt-3 sm:pt-4"}>
      <div className="mx-auto w-full max-w-(--chat-line-width) pb-2">
        <button
          type="button"
...
export const MessagesTimeline = memo(function MessagesTimeline({
  ...
  const renderItem = useCallback(
    ({ item }: { item: MessagesTimelineRow }) => (
      <div
        className="mx-auto w-full min-w-0 max-w-(--chat-line-width) overflow-x-clip"
...
function ContextCompactionTimelineRow({
  ...
  return (
    <div
      ...
      className="mx-auto flex w-full max-w-(--chat-line-width) items-center gap-3 py-1 text-muted-foreground text-xs"
    >
